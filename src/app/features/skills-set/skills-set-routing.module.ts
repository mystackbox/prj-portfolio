...
const routes: Routes = [{ path: '', component: SkillsSetComponent,
    data: {
            ...
            metaTags: [
              ...
              { name: 'image', content: environment.baseUrl + '/img/github-doc-img/yingi-portfolio.png'},
              ...
              { property: 'og:image', content: environment.baseUrl + '/img/github-doc-img/yingi-portfolio.png' },
              { property: 'og:image:secure_url', content: environment.baseUrl + '/img/github-doc-img/yingi-portfolio.png' },
              ...
              { name: 'twitter:image', content: environment.baseUrl + '/img/github-doc-img/yingi-portfolio.png' },
              { name: 'twitter:image:src', content: environment.baseUrl + '/img/github-doc-img/yingi-portfolio.png' },
